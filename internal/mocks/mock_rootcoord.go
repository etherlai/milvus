...
func (_m *RootCoord) BindUserResourceGroups(ctx context.Context, req *internalpb.CredentialInfo) (*commonpb.Status, error) {
	//TODO implement me
	panic("implement me")
}

func (_m *RootCoord) DeleteUsersRG(ctx context.Context, req *internalpb.DeleteUsersRGRequest) (*commonpb.Status, error) {
	//TODO implement me
	panic("implement me")
}
